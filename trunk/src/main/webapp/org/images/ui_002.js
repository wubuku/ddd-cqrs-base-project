...
$.ui.plugin.add("resizable", "alsoResize", {
  ...
  $(document).ready(function(){
	//$("#resizableTextBox").resizable({minWidth: 100, minHeight: 100, maxWidth: 250, maxHeight: 250 });
		
	/*	var arr = $('.txtAreaClass');
		for(i=0;i<arr.length;i++)
		{
			arr[i].id = 'txtAreaId'+i;
		}

*/
		$(".txtAreaClass").bind("click", function() {		
				//txtAreaID= event.srcElement.id;				
				if($(this).attr("activateResize")!="true")
				{				
					$(this).resizable({minWidth: 100, minHeight: 100, handles: "s", autoHide: true  }); //s,e,se
					$(this).attr("activateResize","true");
				}
		})
 });