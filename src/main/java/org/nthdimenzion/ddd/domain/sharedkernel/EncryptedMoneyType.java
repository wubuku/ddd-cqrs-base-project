...
public class EncryptedMoneyType implements CompositeUserType {

    BasicDecimalNumberEncryptor decimalEncryptor = new BasicDecimalNumberEncryptor();

    public EncryptedMoneyType() {
    ...
    public Class returnedClass() {
        return EncryptedMoneyType.class;
    }
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
        ...
        BigDecimal encryptedValue = BigDecimalType.INSTANCE.nullSafeGet(rs, names[0], session);
        BigDecimal amount = decimalEncryptor.decrypt(encryptedValue);
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SessionImplementor session) throws HibernateException, SQLException {
        if (value == null) {
            ...
            BigDecimal encryptedValue = decimalEncryptor.encrypt(money.getAmount());
            BigDecimalType.INSTANCE.set(st, encryptedValue, index, session);
